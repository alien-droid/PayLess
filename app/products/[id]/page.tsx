...
import { fetchSimilarProducts, getProductById } from '@/lib/actions'
  ...
  return (
        ...
        <div className='flex gap-28 xl:flex-row flex-col'>
            ...
            <div className='flex-1 flex flex-col'>
                <div className='flex justify-between items-start gap-5 flex-wrap pb-6'>
                    <div className='flex flex-col gap-3'>
                        ...
                        target='_blank'
                        className='text-bsae text-black opacity-50'>
                            Product 🔗
                        </Link>
            ...
            <div className='product-info'>
                        <div className='flex flex-col gap-3'>
                            ...
                            <p className='text-[21px] text-secondary font-bold opacity-50 line-through'>{product.currency} {formatNumber(product.originalPrice)}</p>
                        </div>
                        <div className='flex flex-col gap-4'>
                            <div className='flex gap-3'>
                                <div className='product-stars'>
                                    <Image src='/assets/icons/star.svg' alt='star' height={16} width={16}/>
                                    <p className='text-sm text-primary-orange font-semibold'>{product.stars || '20'}</p>
                                </div>
    ...
    <div className='flex flex-col gap-16 border-l-black'>
        <div className='flex flex-col gap-5'>
          <h3 className='text-2xl text-secondary font-bold underline'>
              Product Description      
          </h3>     
